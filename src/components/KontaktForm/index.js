...
const KontaktForm = () => {
  return (
    <Form>
      ...
      <Row className="flex-column flex-sm-row justify-content-sm-around ms-3 ms-sm-2 g-0">
        <Col sm={6} className='ps-sm-0 pe-sm-4 pe-4 order-sm-1 order-2'>
          <p className="form-text me-sm-4 pe-5 me-1 py-sm-0 py-3">
            Diese Website ist durch reCAPTCHA geschützt und es gelten die
            Datenschutzbestimmungen und Nutzungsbedingungen von Google
          </p>
           </Col>
         <Col xs={4} sm={2} className='mb-sm-2 me-sm-5 p-2 px-sm-1 bg-light d-flex justify-content-center align-items-sm-center order-1'>
